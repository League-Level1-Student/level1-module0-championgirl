...
//---------------------------------------------------------------------------------------------------------
		String qna = JOptionPane.showInputDialog("who is this?");

		
		if(qna.equalsIgnoreCase("Leonardo")) {
		...
		String q = JOptionPane.showInputDialog("who is this?");

		
		if(q.equalsIgnoreCase("Morgan")) {
	...
	String question = JOptionPane.showInputDialog("who is this?");
		...
		if(question.equalsIgnoreCase("Jack")) {
		...
		JOptionPane.showMessageDialog(null,"You scored " + score + "/4");
